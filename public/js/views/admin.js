...
const A2_ZARF_EXEN = {
  ...
  "oldukça":"Quite a beautiful day.","tamamen":"I completely agree.","neredeyse":"Almost ready.","kesinlikle":"Definitely not.","özellikle":"Especially in summer.","ayrıca":"Also, don't forget this.","ancak":"However, I have no time.","maalesef":"Unfortunately not possible.","neyse ki":"Fortunately it worked out.","muhtemelen":"Probably tomorrow.","sonunda":"We finally arrived.","derhal":"Please respond immediately.","yavaş yavaş":"Things are gradually improving.","aynı zamanda":"Working two jobs at the same time is hard.","bir süre":"I will be away for a while.",
  "tam olarak":"That is exactly what I meant.","açıkça":"Let me say this clearly.","doğrudan":"I spoke to him directly.","önceden":"Please let me know beforehand.","sonradan":"She learned about it later.","kısa süre içinde":"We will finish in a short time.","uzun vadede":"This will be beneficial in the long run.","adım adım":"Let's do it step by step.","dikkatle":"Handle it carefully.","sabırla":"Do it patiently."
};
...
function buildCardHTML(word, index, total) {
  ...
  const catLabel = cardCategory === 'fiil' ? 'Fiil' : cardCategory === 'sifat' ? 'Sıfat' : cardCategory === 'zarf' ? 'Zarf' : 'İsim';
  const exEnMaps = { a1: { isim: A1_ISIM_EXEN, fiil: A1_FIIL_EXEN, sifat: A1_SIFAT_EXEN, zarf: A1_ZARF_EXEN }, a2: { isim: A2_ISIM_EXEN, fiil: A2_FIIL_EXEN, sifat: A2_SIFAT_EXEN, zarf: A2_ZARF_EXEN } };
